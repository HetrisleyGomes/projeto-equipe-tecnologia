...
class RequisicaoController:
    ...
    def update_infos(self, id, description, propriety, status, data_conclusao, servicos, nome_requisitante) -> Dict:
        try:
            ...
            self.__repository.edit_requisition(id, description, propriety, status, data_conclusao, servicos, nome_requisitante)
            data = id
            return {"body": data, "status": 200}
        except Exception as e:
            return {"body": {"error": e}, "status": 400}
